...
Akeno_IMG = "https://telegra.ph/file/6b4c7fc6377a4493a4d05.jpg"
...
def info(update: Update, context: CallbackContext):
    ...
    [
                        InlineKeyboardButton(
                             text="Health",
                             url="https://t.me/Hori_Updates/9"),
                       InlineKeyboardButton(
                             text="Disasters",
                             url="https://t.me/Hori_Updates/5"),
                    ],
    ]
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n[Support](https://t.me/{SUPPORT_CHAT}) | [Updates](https://t.me/HORI_SUPPORT)\n\n"
            + "\n╘══「 by [Silence](https://t.me/Official_Kaushik_Girl) 」\n",
            parse_mode=ParseMode.MARKDOWN,
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n[Support](https://t.me/{SUPPORT_CHAT}) | [Updates](https://t.me/Hori_Updates)\n\n"
                )
                + "╘══「 by [Silence](https://t.me/Official_Kaushik_Girl) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
